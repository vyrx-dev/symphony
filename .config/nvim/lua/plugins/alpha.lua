...
dashboard.button("f", "Ψ  > Find file", ":lua require('telescope.builtin').find_files{ hidden=true, file_ignore_patterns={'%.git/', 'node_modules/'} }<CR>"),
  dashboard.button("r", "ϗ  > Recent", ":Telescope oldfiles<CR>"),
